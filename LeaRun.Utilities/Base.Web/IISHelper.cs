...
namespace LeaRun.Utilities.Base.Web
{
    public class IISHelper
    {
        ...
        public static int GetWebSiteID(string serverName, string siteName)
        {
            int siteID = -1;
        ...
        public static string AddHostHeader(string siteName, string ip, int port, string domain)
        {
           return AddHostHeader("localhost", siteName, ip, port, domain);
        }
        ...
        /// <param name="port">端口</param>  
        /// <param name="domain">域名</param>  
        public static string  AddHostHeader(string serverName, string siteName, string ip, int port, string domain)
        {
            //if (impersonateValidUser("administrators"))
            //{
