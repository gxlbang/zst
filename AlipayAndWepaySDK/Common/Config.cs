...
namespace AlipayAndWepaySDK
{
    public static class AlipayConfig
    {
        ...
        public static string ALIPay_ReturnURL = ConfigurationManager.AppSettings["ALIPay_ReturnURL"];
        ...
        public static string ALIPay_RSA2_PUBLICKEY = ConfigurationManager.AppSettings["ALIPay_RSA2_PUBLICKEY"];
        public static string ALIPay_RSA2_PRIVATEKEY = ConfigurationManager.AppSettings["ALIPay_RSA2_PRIVATEKEY"];
        public static string ALIPay_RSA2_ALI_PUBLICKEY = ConfigurationManager.AppSettings["ALIPay_RSA2_ALI_PUBLICKEY"];
        #endregion
    }
    ...
    public static class WepayConfig
    {
        ...
        public static string WEPAY_APP_APPID = ConfigurationManager.AppSettings["WEPAY_APP_APPID"];
        public static string WEPAY_APP_MCH_ID = ConfigurationManager.AppSettings["WEPAY_APP_MCH_ID"];
        public static string WEPAY_APP_NOTIFY_URL = ConfigurationManager.AppSettings["WEPAY_APP_NOTIFY_URL"];
        public static string WEPAY_APP_URL = ConfigurationManager.AppSettings["WEPAY_APP_URL"];
        ...
        public static string WEPAY_WEB_APIPAYKEY = ConfigurationManager.AppSettings["WEPAY_WEB_APIPAYKEY"];
        public static string WEPAY_WEb_AppSecret = ConfigurationManager.AppSettings["WEPAY_WEb_AppSecret"];
