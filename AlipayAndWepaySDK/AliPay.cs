...
namespace AlipayAndWepaySDK
{
    ...
    public class AliPay : IAlipay
    {
        ...
        private SortedDictionary<string, string> CreateParam(string orderNo, string subject, decimal totalAmt, EnumAliPayTradeType aliPayType)
        {
            ...
            if(service == AlipayConfig.ALIPay_WEB_SERVICE)
            {
                dic.Add("return_url", AlipayConfig.ALIPay_ReturnURL);
            }
            ...
            dic.Add("seller_email", AlipayConfig.ALI_SELLEREMAIL);
