...
namespace LeaRun.Entity
{
    ...
    /// </author>
    /// </summary>
    [Description("Am_Contract")]
    [PrimaryKey("Number")]
    public class Am_Contract : BaseEntity
    {
        #region 获取/设置 字段值
        /// <summary>
        /// Number
