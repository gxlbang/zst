...
namespace LeaRun.Business
{
    ...
    public class CodeMaticBll
    {
        ...
        public string CodeBuilder_Entity(string table, string Key, DataTable Entity_dt)
        {
            ...
            sb_Entity.Append("/*\r\n");
            sb_Entity.Append("* 姓名:gxlbang\r\n");
            sb_Entity.AppendFormat("* 类名:{0}\r\n", EntityName);
            sb_Entity.Append("* CLR版本：\r\n");
            sb_Entity.AppendFormat("* 创建时间:{0}\r\n",DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
            sb_Entity.Append("* 功能描述:\r\n");
            sb_Entity.Append("*\r\n");
            sb_Entity.Append("* 修改历史：\r\n");
            sb_Entity.Append("*\r\n");
            sb_Entity.Append("* ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓\r\n");
            sb_Entity.Append("* ┃            Copyright(c) gxlbang ALL rights reserved                    ┃\r\n");
            sb_Entity.Append("* ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛\r\n");
            sb_Entity.Append("*/\r\n");
        ...
        public string GetCodeBuilderBusiness(string table)
        {
            ...
            sb_Business.Append("/*\r\n");
            sb_Business.Append("* 姓名:gxlbang\r\n");
            sb_Business.AppendFormat("* 类名:{0}\r\n", EntityName);
            sb_Business.Append("* CLR版本：\r\n");
            sb_Business.AppendFormat("* 创建时间:{0}\r\n", DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
            sb_Business.Append("* 功能描述:\r\n");
            sb_Business.Append("*\r\n");
            sb_Business.Append("* 修改历史：\r\n");
            sb_Business.Append("*\r\n");
            sb_Business.Append("* ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓\r\n");
            sb_Business.Append("* ┃            Copyright(c) gxlbang ALL rights reserved                    ┃\r\n");
            sb_Business.Append("* ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛\r\n");
            sb_Business.Append("*/\r\n");
