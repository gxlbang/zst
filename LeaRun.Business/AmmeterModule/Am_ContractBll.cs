...
namespace LeaRun.Business
{
    ...
    /// </author>
    /// </summary>
    public class Am_ContractBll : RepositoryFactory<Am_Contract>
    {
        /// <summary>
        /// 获取列表-导出
        /// </summary>
        ...
        /// <returns></returns>
        public IList<Am_Contract> GetPageList(ref JqGridParam jqgridparam, string keywords, int Stuts, string ProvinceId,
            string CityId, string CountyId, string BeginTime, string EndTime)
        {
            StringBuilder strSql = new StringBuilder();
            List<DbParameter> parameter = new List<DbParameter>();
            strSql.Append(@"SELECT  *
                            FROM  Am_Contract where 1=1 ");
            //用户限定
        ...
        /// <param name="jqgridparam">分页条件</param>
        /// <returns></returns>
        public IList<Am_ContractImage> GetPageList(string Number)
        {
            ...
            //账单编号
            strSql.Append(" AND AC_Number = @AC_Number");
            parameter.Add(DbFactory.CreateDbParameter("@AC_Number", Number));
            return database.FindList<Am_ContractImage>(strSql.ToString(), parameter.ToArray());
        }
        /// <summary>
        /// 获取列表-导出
        /// </summary>
        /// <param name="jqgridparam">分页条件</param>
        /// <returns></returns>
        public IList<Am_Contract> GetPageList(string keywords, int Stuts, string ProvinceId,
            string CityId, string CountyId, string BeginTime, string EndTime)
        {
            StringBuilder strSql = new StringBuilder();
            List<DbParameter> parameter = new List<DbParameter>();
